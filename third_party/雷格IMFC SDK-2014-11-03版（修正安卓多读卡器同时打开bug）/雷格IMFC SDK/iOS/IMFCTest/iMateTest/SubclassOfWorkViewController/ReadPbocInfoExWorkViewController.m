//
//  ReadPbocInfoExWorkViewController.m
//  iMateTest
//
...
@interface ReadPbocInfoExWorkViewController () <iMateAppFaceDelegate>

@property (strong, nonatomic) iMateAppFace *imateAppFace;

@end

@implementation ReadPbocInfoExWorkViewController
...
- (void)iMateDelegateICResetCard:(NSInteger)returnCode resetData:(NSData *)resetData tag:(NSInteger)tag error:(NSString *)error
{
    ...
    [self showLogMessage:@"正在读Pboc卡信息(扩展）..."];
    [self.imateAppFace pbocReadInfoEx:0];
}
